...
let footinglength=0
function addlength(){
    const length=parseFloat(getdata("columnbaseslengthinput"))
    const number=parseFloat(getdata("columnbasesnumberinput"))
    footinglength+=(length+number)
    document.getElementById("columnbaseslengthinput").value=""
    document.getElementById("columnbasesnumberinput").value=""
    document.getElementById("footinglengthlabel").innerHTML=`length:${footinglength}mm`
    localStorage.setItem("footing length",footinglength)
}
document.getElementById("addlengthbutton").addEventListener("click",addlength)
