  ...
  event.waitUntil(
    caches.open('app-cache').then((cache) => {
      return cache.addAll([
        ...
        '/Mywebapp/quantities/concretevolume/otherconcretestructures/index.html',
        '/Mywebapp/quantities/concretevolume/staircase/index.html',
        ...
        '/Mywebapp/materials/wall/plaster/index.html',
